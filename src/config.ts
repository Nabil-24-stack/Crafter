...
export const config = {
  ...
  BACKEND_URL: 'https://crafter-kcf6gnhzx-nabilhasan24-gmailcoms-projects.vercel.app/api/generate',

  // Multi-phase generation endpoint (optimized single-call with smart component limiting)
  BACKEND_URL_MULTI_PHASE: 'https://crafter-kcf6gnhzx-nabilhasan24-gmailcoms-projects.vercel.app/api/generate-multi-phase',
